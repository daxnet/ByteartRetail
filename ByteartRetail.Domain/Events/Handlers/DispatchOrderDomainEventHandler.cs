...
namespace ByteartRetail.Domain.Events.Handlers
{
    ...
    /// </summary>
    public class DispatchOrderDomainEventHandler : IDomainEventHandler<DispatchOrderEvent>
    {
        ...
        public DispatchOrderDomainEventHandler(IRepositoryContext context, ISalesOrderRepository salesOrderRepository)
        {
        ...
        public void Handle(DispatchOrderEvent evnt)
        {
